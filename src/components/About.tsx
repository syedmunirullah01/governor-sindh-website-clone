  ...
  return (
    <section className="relative mt-20">
      <div className="max-w-[90%] mx-auto">
        <div>
          <h2 className="text-xl md:text-3xl md:max-w-[90%] mx-auto font-bold mb-10 text-[#044e83] text-center">
            Certified Cloud Applied Generative AI Engineer (GenEng) and
            Solopreneur Developing Billion-Dollar Valued Developers and
            Solopreneurs
          </h2>
          <p className="text-black text-lg md:text-xl leading-8 tracking-normal text-justify">
        ...
        <div className="flex md:flex-row flex-col justify-between gap-4 items-center mt-8">
          <Image
            ...
            width={350}
            height={300}
            className="rounded-lg h-[300px] shadow-2xl shadow-black object-cover"
          />
          <Image
            src="/about2.jpg"
            alt="solopreneur"
