  ...
  return (
    <section className="mt-24 relative mb-20">
      <div className="max-w-[90%] mx-auto">
        <h2 className="text-[#044E83] text-4xl font-bold mb-10">
        ...
        <div className="flex justify-start gap-10 items-center mb-20 md:flex-row flex-col">
          {CourseData.map((ele, id) => {
            return (
              <div
                key={id}
                className="md:w-[245px] w-full h-[342px] md:h-[234px] border rounded-lg shadow-2xl shadow-black transition-all duration-300 hover:scale-105"
              >
                <Image
                  src={ele.img}
                  alt="img"
                  width={245}
                  height={163}
                  className="rounded-t-lg md:w-[245px] md:h-[163px] w-full h-[272px]"
                />
                <h3 className="text-center mt-4 text-lg font-semibold text-gray-500">
                  {ele.title}
                </h3>
              </div>
            );
            ...
            return (
              ...
              >
                <Image
                  ...
                  className="rounded-t-lg md:w-[245px] md:h-[163px] w-full h-[272px]"
                />
                <h3 className="text-center mt-2 text-lg font-bold text-gray-500 max-w-[98%] mx-auto">
                  {ele.title}
                </h3>
              </div>
            );
